...
import { startListening, onClipboardChange, stopListening, writeFiles, writeImage, writeText, getDefaultSaveImagePath } from "tauri-plugin-clipboard-x-api";
...
function App() {
  ...
  useEffect(() => {
    ...
    listenToClipboard();
    manageAutostart();
    console.log(getDefaultSaveImagePath())
